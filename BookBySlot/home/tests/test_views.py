...
class DashboardViewTest(TestCase):
    ...
    def test_view_update_profile(self):
        ...
        self.assertEqual(test_user3_profile.contact_no, '1234356456')
        self.assertEqual(test_user3_profile.address, 'Kanpur')
...
class SetProfileViewTest(TestCase):
    ...
    def test_view_when_data_provided_through_POST(self):
        ...
        self.assertEqual(test_user2_profile.contact_no, '1234356456')
        self.assertEqual(test_user2_profile.address, 'Kanpur')
